...
def get_data_loaders(
    ...
    train_data = datasets.ImageFolder(base_path / "train", data_transforms["train"])
    # The validation dataset is a split from the train_one_epoch dataset, so we read
    # from the same folder, but we apply the transforms for validation
    valid_data = datasets.ImageFolder(base_path / "train", data_transforms["valid"])
    ...
    test_data = datasets.ImageFolder(base_path / "test", data_transforms["test"])
